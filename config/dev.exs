...
config :broodwar, BroodwarWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:broodwar, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:broodwar, ~w(--watch)]}
  ]
...
config :broodwar, BroodwarWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/broodwar_web/router\.ex$"E,
      ~r"lib/broodwar_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
