defmodule Broodwar.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: Broodwar.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    BroodwarWeb.Endpoint.config_change(changed, removed)
    :ok
  end
